---
name: xxd-panel-204
description: "Create Panel 204 raster artwork: Soft-focus Light-memory Vignette. Use when the user invokes xxd-panel-204 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-204/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-204-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
