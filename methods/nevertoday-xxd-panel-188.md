---
name: xxd-panel-188
description: "Create Panel 188 raster artwork: Warm Gold Architectural Archive. Use when the user invokes xxd-panel-188 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-188/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-188-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
