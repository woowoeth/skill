---
name: xxd-panel-187
description: "Create Panel 187 raster artwork: Archival Collage with Oversized Type. Use when the user invokes xxd-panel-187 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-187/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-187-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
