...
## Project Additions (camo-generator, outside managed block)

- Token names are defined in `src/styles/tokens/_semantic.scss` (source of truth). Components use `var(--…)` only; never write raw hex / px values in component styles.
