...
# --------------------------------------------------------------------- static pages
_PAGE_CSS = (
    # 北欧黑白风 nordic-bw v1.0 —— token 与站点主页一致；结构与字段不变，只换视觉层
    ":root{color-scheme:light only;"
    "--ink:#0a0a0a;--ink-70:#404040;--ink-50:#666666;--ink-30:#b3b3b3;"
    "--hairline:#e5e5e5;--surface:#ffffff;--bg:#fafafa;--tint:#f0f0f0;"
    "--sp-1:4px;--sp-2:8px;--sp-3:12px;--sp-4:16px;--sp-5:24px;--sp-6:32px;"
    "--fs-caption:11px;--fs-body:13px;--fs-strong:14px;--fs-heading:16px;"
    "--r-block:8px;"
    "--font:'Inter','Noto Sans CJK SC','PingFang SC','Hiragino Sans GB',system-ui,sans-serif}"
    "*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);"
    "font:var(--fs-heading)/1.75 var(--font);-webkit-font-smoothing:antialiased}"
    "main{max-width:720px;margin:0 auto;padding:var(--sp-5) var(--sp-5) 72px}"
    "a{color:var(--ink)}"
    "nav.bc{font-size:var(--fs-body);color:var(--ink-50);margin:var(--sp-2) 0 var(--sp-5)}"
    "nav.bc a{color:var(--ink-50);text-decoration:none}nav.bc a:hover{text-decoration:underline}"
    "h1{font-size:26px;line-height:1.3;margin:0 0 var(--sp-3);letter-spacing:-.01em}"
    "h2{font-size:var(--fs-heading);margin:var(--sp-6) 0 var(--sp-2);letter-spacing:-.005em}"
    ".lede{font-size:var(--fs-heading);color:var(--ink-70);margin:0 0 var(--sp-5)}"
    ".meta{font-size:var(--fs-body);color:var(--ink-50);margin:0 0 var(--sp-5)}"
    ".tags{margin:var(--sp-5) 0 0}.tags a,.tags span{display:inline-block;font-size:var(--fs-caption);"
    "color:var(--ink-70);background:var(--tint);border-radius:999px;padding:var(--sp-1) var(--sp-3);"
    "margin:0 var(--sp-2) var(--sp-2) 0;text-decoration:none}"
    "footer{margin-top:var(--sp-6);padding-top:var(--sp-5);border-top:1px solid var(--hairline);"
    "font-size:var(--fs-body);color:var(--ink-50)}footer a{color:var(--ink-70)}"
    "p{margin:0 0 var(--sp-3)}.sib{margin-top:var(--sp-6);font-size:var(--fs-strong)}"
    "ul.idx{padding-left:18px}ul.idx li{margin:0 0 var(--sp-3)}"
)
...
def page_404(site, hubs):
    ...
    head = ('<meta name="robots" content="noindex,follow">'
            '<link rel="canonical" href="%s">' % esc(site.url("404.html")))
